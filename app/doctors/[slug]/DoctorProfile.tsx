...
export default function DoctorProfile({ doctor }: { doctor: DoctorRecord }) {
  ...
  useEffect(() => {
    const saved = window.localStorage.getItem('akadent-language');
